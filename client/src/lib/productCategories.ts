...
const CATEGORIES: ProductCategory[] = [
    ...
    subcategories: [
      {
        id: "wired-chassis",
        label: "插槽式",
        sheetPatterns: [/omniswitch\s+9900/i, /omniswitch\s+9500/i, /^OS\s*9900$/i, /^OS\s*9500$/i],
  ...
  },
  {
    id: "wireless",
    label: "无线网络系统",
    sheetPatterns: [/omniaccess(?!.*esr)/i, /^OAW/i],
  },
  {
    id: "nms",
    label: "网管系统",
    sheetPatterns: [/omnivista(?!.*3600)/i, /^OV\s*2500/i],
  },
  {
    id: "security",
    label: "网络安全系统",
